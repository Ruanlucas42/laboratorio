    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/laboratorios/buscar").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.PUT,"/laboratorios/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,"/laboratorios/**").hasAnyRole("ADMIN","USER")
                        .requestMatchers(HttpMethod.DELETE,"/laboratorios/**").hasRole("ADMIN")
